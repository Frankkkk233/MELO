...
def tokenize_counterfact(batch, tokenizer, device, **kwargs):
    ...
    locality_prompt = batch['locality_prompt']
    locality_ans = batch['locality_ground_truth']
    ...
    conbined_locality = [f'{locality_prompt}{locality_ans}' for locality_prompt, locality_ans in zip(locality_prompt, locality_ans)]
